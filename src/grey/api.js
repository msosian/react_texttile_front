...
export const getReport=(input)=>fetch(`http://localhost/sites/project/invoice/report`,{
    method:"POST",
    headers:{
...
export const getReportM=()=>fetch(`http://localhost/sites/project/invoice/reportm`).then(res=>res.json())
